<%@ Page Title="" Language="C#" MasterPageFile="~/Site_Main.Master" AutoEventWireup="true" CodeBehind="Report2.aspx.cs" Inherits="Ozoneservice.Train.Report2" %>
   ...
   <div class="table-responsive">
    <table  class="table table-hover "  style="margin-left:30px;"  >
        ...
        <tr><!-- Contentdata-->
            ...
            <td>
                <asp:Button ID="btnEmp" runat="server" Text="ดูรายละเอียดการอบรม" CssClass="btn btn-primary" OnClick="btnEmp_Click"  />
            </td>        
        </tr>
        ...
        <tr><!-- Contentdata-->
            ...
            <td>เจ้าหน้าที่ IT</td>
            <td>
                <asp:Button ID="Button1" runat="server" Text="ดูรายละเอียดการอบรม" CssClass="btn btn-primary"  />
            </td>
        ...
        <tr ><!-- Contentdata-->
            ...
            <td>เจ้าหน้าที่ IT</td>
            <td>
                <asp:Button ID="Button2" runat="server" Text="ดูรายละเอียดการอบรม" CssClass="btn btn-primary" />
            </td>
        ...
        <tr><!-- Contentdata-->
            ...
            <td>เจ้าหน้าที่ IT</td>
            <td>
                <asp:Button ID="Button3" runat="server" Text="ดูรายละเอียดการอบรม" CssClass="btn btn-primary"  />
            </td>
