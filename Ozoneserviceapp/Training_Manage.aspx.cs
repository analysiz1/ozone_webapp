...
namespace Ozoneserviceapp
{
    public partial class Training_Manage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            outputHTML = @"<table style='width: 80%;' align='center' class=' table table-bordered'>
            <tr>
            ...
            foreach(System.Data.DataRow dr in dtTitleTraining.Rows)
             ...
             outputHTML += @"<td style=' width: auto ; align='center'>                       
                         <input type ='button' id='btnEdit'  onclick='btnedit(" + dr["Trainning_id"].ToString() + ");' value='แก้ไข' runat='server' Class='btn btn-warning'align ='center' /></td>";
             outputHTML += @"<td style=' width: auto ; align='center'>";                        
             outputHTML += @"<input type ='button'  runat='server' onclick='btndelete("+dr["Trainning_id"].ToString() +");' id='btnDelete' runat='server' value='ลบข้อมูล' Class='btn btn-danger'align ='center' /></td>";
             outputHTML += @"<td> <input type ='button' id='BtnManage2' value='จัดการคน' runat='server' onclick='btnmanage(" + dr["Trainning_id"].ToString() + ");' Class='btn btn-primary'align ='center' /> </td>";                               
